{{-- resources/views/admin/sms/templates/create.blade.php --}}
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Create SMS Template</h1>
                <p class="text-sm text-gray-600 mt-1">Create a reusable message template</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('admin.sms.templates.store') }}" method="POST" class="p-6">
            @csrf
