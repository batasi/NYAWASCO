    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('admin.events') }}" class="font-medium text-green-600 hover:text-green-700">
                            View all events
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('admin.voting') }}" class="font-medium text-purple-600 hover:text-purple-700">
                            View all contests
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="p-6">
                    <div class="text-center">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('admin.events') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Review Now
                            </a>
                        </div>
                    </div>
