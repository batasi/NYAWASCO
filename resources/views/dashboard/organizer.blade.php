    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('organizer.events') }}"
                            class="font-medium text-blue-600 hover:text-blue-700">View all events</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['total_voting_contests'] ?? 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('organizer.voting') }}"
                            class="font-medium text-purple-600 hover:text-purple-700">View all contests</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['total_ticket_sales'] ?? 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('organizer.analytics') }}"
                            class="font-medium text-green-600 hover:text-green-700">View analytics</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    KSh {{ number_format($stats['total_revenue'] ?? 0, 2) }}
                                </dd>
                            </dl>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 px-5 py-3">
                    <div class="text-sm">
                        <a href="{{ route('organizer.analytics') }}"
                            class="font-medium text-yellow-600 hover:text-yellow-700">View revenue</a>
                    </div>
                </div>
            </div>
        </div>

        <!-- Recent Ticket Sales and Upcoming Events -->
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="p-6 hover:bg-gray-50 transition duration-150 ease-in-out">
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0">
                                <h4 class="text-base font-medium text-gray-900 truncate">{{ $sale->event->name }}</h4>
                                ...
                                <div class="mt-1 flex items-center text-sm text-gray-500">
                                    ...
                                    KSh {{ number_format($sale->final_amount, 2) }} • {{ $sale->quantity }}
                                    {{ Str::plural('ticket', $sale->quantity) }}
                                </div>
                            </div>
                        ...
                        <div class="mt-4 flex space-x-3">
                            ...
                            <span class="inline-flex items-center px-3 py-1 border border-gray-300 text-xs font-medium rounded-md text-gray-700 bg-white">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-semibold text-gray-900">No ticket sales yet</h3>
                        <p class="mt-1 text-sm text-gray-500">Ticket sales will appear here once customers purchase tickets to your events.</p>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-semibold text-gray-900">No upcoming events</h3>
