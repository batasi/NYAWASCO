...
<div class="min-h-screen modal-bg py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="modal-header rounded-lg shadow-sm border border-gray-200 p-8">
            <h1 class="text-3xl font-bold mb-6" style="color: rgba(198, 0, 238, 1);">Terms of Service</h1>
            <div class="prose prose-blue max-w-none">
                <p class="text-lg text-gray-200 mb-6">Last updated: {{ date('F j, Y') }}</p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">1. Acceptance of Terms</h2>
                <p class="text-gray-200 mb-4">
                    By accessing and using Javent, you accept and agree to be bound by the terms and provision of this agreement.
                </p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">2. Use License</h2>
                <p class="text-gray-200 mb-4">
                    Permission is granted to temporarily use Javent for personal, non-commercial transitory viewing only.
                </p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">3. User Accounts</h2>
                <p class="text-gray-200 mb-4">
                ...
                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">4. Event Tickets and Voting</h2>
                <p class="text-gray-200 mb-4">
                    All ticket sales are final unless otherwise stated. Voting results are determined by participant votes and are final.
                </p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">5. Prohibited Uses</h2>
                <p class="text-gray-200 mb-4">
                    You may not use our service for any illegal or unauthorized purpose. You must not violate any laws in your jurisdiction.
                </p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">6. Termination</h2>
                <p class="text-gray-200 mb-4">
                ...
                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">7. Changes to Terms</h2>
