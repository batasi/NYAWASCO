...
<div class="min-h-screen modal-bg py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="modal-header rounded-lg shadow-sm border border-gray-200 p-8">
            <h1 class="text-3xl font-bold mb-6" style="color: rgba(198, 0, 238, 1);">Privacy Policy</h1>
            <div class="prose prose-blue max-w-none">
                <p class="text-lg text-gray-200 mb-6">Last updated: {{ date('F j, Y') }}</p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">1. Information We Collect</h2>
                ...
                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">2. How We Use Your Information</h2>
                <p class="text-gray-200 mb-4">
                ...
                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">3. Information Sharing</h2>
                <p class="text-gray-200 mb-4">
                    We do not sell, trade, or otherwise transfer your personal information to third parties without your consent,
                    except as described in this Privacy Policy or as required by law.
                </p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">4. Data Security</h2>
                <p class="text-gray-200 mb-4">
                    We implement appropriate technical and organizational security measures designed to protect your personal information.
                </p>

                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">5. Your Rights</h2>
                <p class="text-gray-200 mb-4">
                ...
                <h2 class="text-2xl font-semibold text-purple-500 mt-8 mb-4">6. Contact Us</h2>
