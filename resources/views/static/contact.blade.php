...
@section('content')
<div class="min-h-screen modal-header py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="modal-bg rounded-lg shadow-sm border border-gray-200 p-8">
            <h1 class="text-3xl font-bold mb-6" style="color: rgba(198, 0, 238, 1);">Contact Us</h1>
            <div class="prose prose-blue max-w-none">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                        <h2 class="text-xl font-semibold mb-4" style="color: rgba(198, 0, 238, 1)">Get In Touch</h2>
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-200">Phone</h3>
                                    <p class="text-gray-100">+254 727-147-442</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <svg class="w-6 h-6 text-purple-600 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-200">Email</h3>
                                    <p class="text-gray-100">info@javapa.com</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <svg class="w-6 h-6 text-purple-600 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-100">Kisii, Kenya<br>Along Kisii-Nyamira Highway</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <h2 class="text-xl font-semibold mb-4" style="color: rgba(198, 0, 238, 1);">Send us a Message</h2>
                        <form class="space-y-4">
                            ...
                            <div>
                                <label for="message" class="block text-sm font-medium text-gray-100">Message</label>
                            ...
                            <button type="submit" class="w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                Send Message
                            </button>
                        </form>
                    </div>
