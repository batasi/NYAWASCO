...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
    ...
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-8">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8 overflow-x-auto">
                    <a href="{{ route('system.management', ['tab' => 'overview']) }}"
                    ...
                    <a href="{{ route('system.management', ['tab' => 'maintenance']) }}"
                    ...
                    <a href="{{ route('system.management', ['tab' => 'cache']) }}"
                    ...
                    <a href="{{ route('system.management', ['tab' => 'logs']) }}"
                    ...
                    <a href="{{ route('system.management', ['tab' => 'config']) }}"
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <form method="POST" action="{{ route('system.management.clear-cache') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-4 rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                    ...
                    <form method="POST" action="{{ route('system.management.optimize-db') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                            <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"></path>
                            </svg>
                    ...
                    <form method="POST" action="{{ route('system.management.restart-services') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-yellow-500 to-orange-500 text-white p-4 rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                            <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button type="button"
                            onclick="alert('System report generation not implemented yet')"
                            class="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-4 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                        <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <form method="POST" action="{{ route('system.management.clear-app-cache') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-4 rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                            <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form method="POST" action="{{ route('system.management.clear-route-cache') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                            <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form method="POST" action="{{ route('system.management.clear-config-cache') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-yellow-500 to-orange-500 text-white p-4 rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                            <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form method="POST" action="{{ route('system.management.clear-view-cache') }}" class="inline">
                        @csrf
                        <button type="submit"
                                class="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-4 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex flex-col items-center w-full">
                            <svg class="w-8 h-8 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <form method="GET" action="{{ route('system.management') }}" class="flex items-center space-x-2">
                            <input type="hidden" name="tab" value="logs">
                            <select name="log_level" onchange="this.form.submit()" class="px-4 py-2 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 bg-gray-50 focus:bg-white">
                                <option value="">All Levels</option>
                                <option value="emergency" {{ request('log_level') === 'emergency' ? 'selected' : '' }}>Emergency</option>
                                <option value="alert" {{ request('log_level') === 'alert' ? 'selected' : '' }}>Alert</option>
                                ...
                                <option value="notice" {{ request('log_level') === 'notice' ? 'selected' : '' }}>Notice</option>
                        ...
                        <button type="button"
                                onclick="alert('Log export not implemented yet')"
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
            ...
            <form method="POST" action="{{ route('system.management.save-config') }}" class="space-y-8">
                @csrf
                <!-- General Settings -->
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <select name="timezone"
                                    class="w-full px-4 py-3 border-2 border-blue-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-200 transition-all duration-300 bg-white shadow-sm">
                                <option value="Africa/Nairobi" {{ $config['timezone'] === 'Africa/Nairobi' ? 'selected' : '' }}>East Africa Time (EAT)</option>
                        ...
                        <div class="space-y-3">
                            ...
                            <select name="locale"
                                ...
                                <option value="sw" {{ $config['locale'] === 'sw' ? 'selected' : '' }}>Swahili</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-xl border border-red-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            ...
                            <input type="number" name="session_lifetime" value="{{ $config['session_lifetime'] }}" min="15" max="1440"
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="number" name="max_login_attempts" value="{{ $config['max_login_attempts'] }}" min="3" max="10"
                                   class="w-full px-4 py-3 border-2 border-red-200 rounded-xl focus:border-red-500 focus:ring-4 focus:ring-red-200 transition-all duration-300 bg-white shadow-sm"
                                   placeholder="5">
                        </div>
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" name="enable_2fa" value="1" {{ $config['enable_2fa'] ? 'checked' : '' }} class="rounded border-red-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" name="force_https" value="1" {{ $config['force_https'] ? 'checked' : '' }} class="rounded border-red-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            ...
                            <select name="mail_driver"
                                ...
                                <option value="mailgun" {{ $config['mail_driver'] === 'mailgun' ? 'selected' : '' }}>Mailgun</option>
                                <option value="ses" {{ $config['mail_driver'] === 'ses' ? 'selected' : '' }}>Amazon SES</option>
                            </select>
                        </div>
    ...
    <div class="fixed top-4 right-4 z-50 bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center animate-fade-in-up">
        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    setTimeout(() => {
        const messages = document.querySelectorAll('[class*="animate-fade-in-up"]');
